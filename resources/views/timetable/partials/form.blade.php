...
<div>
    <label class="sc-label">Room</label>
...
<div class="grid gap-3 sm:grid-cols-2">
    <div>
        <label class="sc-label">Day</label>
    ...
    <div>
        <label class="sc-label">Week number</label>
        <input class="sc-input mt-1" name="week_number" type="number" min="1" max="53" value="{{ old('week_number', $session?->week_number ?? now()->weekOfYear) }}">
    </div>
</div>
<div class="grid gap-3 sm:grid-cols-2">
    <div>
        <label class="sc-label">Starts on</label>
        <input class="sc-input mt-1" name="starts_on" type="date" value="{{ old('starts_on', $session?->starts_on?->format('Y-m-d') ?? now()->startOfWeek()->format('Y-m-d')) }}" required>
    </div>
    <div>
        <label class="sc-label">Ends on</label>
        <input class="sc-input mt-1" name="ends_on" type="date" value="{{ old('ends_on', $session?->ends_on?->format('Y-m-d') ?? now()->endOfWeek()->format('Y-m-d')) }}" required>
    </div>
</div>
<div class="grid gap-3 sm:grid-cols-2">
    <div>
...
<div>
    <label class="sc-label">Change note</label>
